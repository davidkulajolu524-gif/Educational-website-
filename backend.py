...
PROMO_ENDS = (datetime.now(timezone.utc) + timedelta(hours=24)).isoformat()
...
COURSES = [
    ...
    {"id": 6, "title": "Data Science", "category": "Data", "price": 79, "original_price": 99, "discount": 20, "promo_ends": PROMO_ENDS, "lesson_list": [{"title": "Data science workflow", "topic": "Move from a question to a defensible answer."}, {"title": "Python data analysis", "topic": "Inspect, transform, and summarize datasets."}, {"title": "Visualize insights clearly", "topic": "Choose charts that make patterns easy to see."}, {"title": "Build a predictive model", "topic": "Train and evaluate a practical first model."}]},
    ...
    {"id": 8, "title": "Digital Marketing", "category": "Business", "price": 25, "original_price": 50, "discount": 50, "promo_ends": PROMO_ENDS, "lesson_list": [{"title": "Audience and content strategy", "topic": "Plan useful content for a specific audience."}, {"title": "Search engine fundamentals", "topic": "Help the right people discover your work."}, {"title": "Social campaign planning", "topic": "Build campaigns with a clear message and goal."}, {"title": "Measure campaign performance", "topic": "Use meaningful metrics to improve future campaigns."}]},
]
